    ...
    return(
        <section className="testimonials" id="testimonials">
            ...
            <div className="testimonial-content">
                ...
                <Swiper className="client-testimonials mySwiper" autoplay={{ delay: 2000, disableOnInteraction: false}} slidesPerView={2} loop={true} grabCursor={false} spaceBetween={24} pagination={false} modules={[Pagination, Autoplay]} breakpoints={{100: {slidesPerView: 1}}}>
