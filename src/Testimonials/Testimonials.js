    ...
    return(
        <section className="testimonials" id="testimonials">
            ...
            <div className="testimonial-content">
                ...
                <Swiper className="client-testimonials mySwiper" autoplay={{ delay: 2000, disableOnInteraction: false}} slidesPerView={2} loop={true} grabCursor={true} spaceBetween={24} pagination={false} breakpoints={{576: { slidesPerView: 1 }, 786: {slidesPerView: 2, spaceBetween: 48 }}} modules={[Pagination, Autoplay]}>
